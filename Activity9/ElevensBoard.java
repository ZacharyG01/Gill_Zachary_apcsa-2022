		...
		for (int c1 = 0; c1 < selectedCards.size(); c1++)
		{
			...
			for (int c2 = c1 + 1; c2 < selectedCards.size(); c2++)
			{
				...
				for (int c3 = c2 + 1; c3 < selectedCards.size(); c3++)
				{
					...
					if (cardAt(k1).rank().equals("king") || cardAt(k2).rank().equals("king") || cardAt(k3).rank().equals("king")) {
						king = true;
					}
					if (cardAt(k1).rank().equals("queen") || cardAt(k2).rank().equals("queen") || cardAt(k3).rank().equals("queen")) {
						queen = true;
					}
					if (cardAt(k1).rank().equals("jack") || cardAt(k2).rank().equals("jack") || cardAt(k3).rank().equals("jack")) {
						jack = true;
					}
				}
			}
